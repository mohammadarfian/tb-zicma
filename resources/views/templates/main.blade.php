...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('icons/zicma.png') }}"/>
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
            <img src="{{ asset('icons/zicma.png') }}" alt="logo" style="height:50px; width:50px; object-fit:contain;" /> </a>
          <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}">
            <img src="{{ asset('icons/zicma.png') }}" alt="logo" /> </a>
        </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="kelola_barang">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/supply/new') }}">Pasok Barang</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="kelola_laporan">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/report/transaction')  }}">Laporan Pemasukan</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/supply/statistics') }}">Laporan Pengeluaran</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/report/recap') }}">Rekap Laporan</a>
                  </li>
                </ul>
              </div>
            </li>
        ...
        <div class="main-panel">
          ...
          <footer class="footer" id="footer-content">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2025 <a href="#" target="_blank">Mohammad Arfian</a>. All rights reserved.</span>
              </span>
            </div>
          </footer>
        </div>
