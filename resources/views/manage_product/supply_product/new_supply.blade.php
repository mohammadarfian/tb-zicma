									...
									<div class="form-group row top-min">
										...
										<div class="col-12">
										  <div class="input-group">
											...
											<input type="text" class="form-control input-notzero" name="harga_beli_display" id="harga_beli_display" placeholder="Masukkan Harga Satuan" required>
...
<script type="text/javascript">
	...
	$(document).on('click', '.btn-tambah', function(e){
		...
		if (!harga_beli || parseInt(harga_beli) <= 0) {
			swal(
			"Input tidak valid",
			"Harga satuan tidak boleh kosong atau nol",
			"error"
			);
			return;
		}
...
<script>
  const inputDisplay = document.getElementById('harga_beli_display');
  const inputHidden = document.getElementById('harga_beli');
