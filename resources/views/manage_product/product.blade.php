    ...
    <div class="page-header d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-start">
      	<div class="dropdown">
            ...
            <a href="#" class="dropdown-item filter-btn" data-filter="kategori">Kategori</a>
            <a href="#" class="dropdown-item filter-btn" data-filter="nama_barang">Nama Barang</a>
            <a href="#" class="dropdown-item filter-btn" data-filter="satuan">Satuan</a>
      ...
      <div class="modal-content">
        <form action="{{ url('/product/update') }}" method="post" name="update_form">
          ...
          <div class="modal-body" id="edit-modal-body">
              ...
              <div class="form-group row">
                <label class="col-lg-3 col-md-3 col-sm-12 col-form-label font-weight-bold">Satuan</label>
                <div class="col-lg-9 col-md-9 col-sm-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-notzero" id="harga_display" placeholder="Masukkan harga">
