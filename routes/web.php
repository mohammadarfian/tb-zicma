...
Route::group(['middleware' => ['auth', 'checkRole:admin,kasir']], function(){
	...
	Route::get('/product/generate-kode/{prefix}', 'ProductManageController@generateKode');
	...
	Route::get('/report/recap', 'ReportManageController@reportRecap')->name('report.recap');
	Route::post('/report/rekap/export', 'ReportManageController@exportRekap')->name('report.export_rekap');
});
